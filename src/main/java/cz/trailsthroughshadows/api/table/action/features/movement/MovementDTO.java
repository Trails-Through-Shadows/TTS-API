...
public class MovementDTO extends Validable {
    @Id
...
//    @JoinTable(
//            name = "MovementEffect",
//            joinColumns = @JoinColumn(name = "idMovement", referencedColumnName = "id"),
//            inverseJoinColumns = @JoinColumn(name = "idEffect", referencedColumnName = "idEffect")
//    )
    @JsonSerialize(using = LazyFieldsSerializer.class)
    private List<MovementEffectDTO> effects;
    ...
    public List<EffectDTO> getMappedEffects() {
        ...
        return effects.stream().map(MovementEffectDTO::getEffect).toList();
    }
