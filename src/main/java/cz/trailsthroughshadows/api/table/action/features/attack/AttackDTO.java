...
public class AttackDTO extends Validable implements Serializable {
    @Id
    ...
    private Collection<AttackEffectDTO> effects;

    @JsonIgnore
    public Collection<EffectDTO> getMappedEffects() {
        if (effects == null) return null;
        return effects.stream().map(AttackEffectDTO::getEffect).toList();
    }
